...
def graph_input():
    try:
        x_values = simpledialog.askstring("Your Data", "Enter X values separated by commas:")
        y_values = simpledialog.askstring("Your Data", "Enter Y values separated by commas:")
